                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/cargos/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/cargos/add`" class="full-width" >
                ...
                <div class="row q-col-gutter-x-md">
                    <div  class="col comp-grid" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && pageBreadCrumb.fieldName">
                                <q-card class="q-pa-md q-mb-sm text-bold nice-shadow-16">
                                    <q-breadcrumbs>
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="pageBreadCrumb.fieldName" to="/cargos"></q-breadcrumbs-el>
                        ...
                        <div >
                            ...
                            :bordered="false"
                            :columns="app.menus.cargoslistheader" 
                            :rows="records"
                            ...
                            <template v-slot:body="props">
                                <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                    ...
                                    <q-td  key="cargo_id" :props="props">
                                        <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/cargos/view/${props.row.cargo_id}`">{{ props.row.cargo_id }}</q-btn>
                                    </q-td>
                                    <q-td  key="cargo_nome" :props="props">
                                        {{ props.row.cargo_nome }}
                                    </q-td>
                                            ...
                                            <q-btn icon="menu" padding="xs" round flat color="grey">
                                                <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                    <q-list dense rounded nav>
                                                        <template v-if="auth.canView('cargos/view')">
                                                            <q-item link clickable v-ripple :to="`/cargos/view/${props.row.cargo_id}`">
                                                                <q-item-section>
                                                        ...
                                                        <template v-if="auth.canView('cargos/edit')">
                                                            <q-item link clickable v-ripple :to="`/cargos/edit/${props.row.cargo_id}`">
                                                                <q-item-section>
                                                        ...
                                                        <template v-if="auth.canView('cargos/delete')">
                                                            <q-item link clickable v-ripple @click="deleteItem(props.row.cargo_id)">
                                                                <q-item-section>
