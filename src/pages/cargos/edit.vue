                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlcargo_nome" v-model.trim="formData.cargo_nome"  label="Cargo Nome" type="text" placeholder="Entrar Cargo Nome"      
                                                    class="" :error="isFieldValid('cargo_nome')" :error-message="getFieldError('cargo_nome')">
                                                    </q-input>
                                                </div>
                                            </div>
                                        </div>
