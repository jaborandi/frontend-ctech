                            ...
                            <div >
                                <div class="q-mb-3 row q-col-gutter-md justify-start">
                                    ...
                                    <div class="col-12 col-md-4">
                                        <q-card  class="q-pa-md nice-shadow-16">
                                            <div class="row q-col-gutter-x-md items-center">
                                                <div class="col">
                                                    <div class="text-grey text-weight-medium mb-1">Nome</div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <q-card  class="q-pa-md nice-shadow-16">
                                            <div class="row q-col-gutter-x-md items-center">
                                                <div class="col">
                                                    <div class="text-grey text-weight-medium mb-1">Detalhes</div>
                                                    <div class="text-bold">{{ item.detalhes }}</div>
                                                </div>
                                            </div>
                                        </q-card>
                                    </div>
                                ...
                                <div class="row q-col-gutter-xs justify-start q-ma-md">
                                    <template v-if="auth.canView('catinvent/edit')">
                                        <div><q-btn icon="edit" label="Edit"  outline  :rounded="false"  no-caps  unelevated   padding="xs" color="positive" title="Editar"  @click="app.openPageDialog({ page:'catinvent/edit', url: `/catinvent/edit/${item.id}` , closeBtn: true })">
                                        </q-btn></div>
                                    </template>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'catinventview',
		},
		apiPath: {
			type: String,
			default: 'catinvent/view',
		},
		autoLoad: {
			type: Boolean,
			default: true,
