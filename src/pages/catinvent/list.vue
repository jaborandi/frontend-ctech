                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/catinvent/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/catinvent/add`" class="full-width" >
                ...
                <div class="row q-col-gutter-x-md">
                    <div  class="col comp-grid" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && pageBreadCrumb.fieldName">
                                <q-card class="q-pa-md q-mb-sm text-bold nice-shadow-16">
                                    <q-breadcrumbs>
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="pageBreadCrumb.fieldName" to="/catinvent"></q-breadcrumbs-el>
                        ...
                        <div >
                            ...
                            :bordered="false"
                            :columns="app.menus.catinventlistheader" 
                            :rows="records"
                            ...
                            <template v-slot:body="props">
                                <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                    ...
                                    <q-td  key="id" :props="props">
                                        <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/catinvent/view/${props.row.id}`">{{ props.row.id }}</q-btn>
                                    </q-td>
                                    <q-td  key="nome" :props="props">
                                        {{ props.row.nome }}
                                    </q-td>
                                    <q-td  key="detalhes" :props="props">
                                        {{ props.row.detalhes }}
                                    </q-td>
                                            ...
                                            <q-btn icon="menu" padding="xs" round flat color="grey">
                                                <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                    <q-list dense rounded nav>
                                                        <template v-if="auth.canView('catinvent/view')">
                                                            <q-item link clickable v-ripple :to="`/catinvent/view/${props.row.id}`">
                                                                <q-item-section>
                                                        ...
                                                        <template v-if="auth.canView('catinvent/edit')">
                                                            <q-item link clickable v-ripple :to="`/catinvent/edit/${props.row.id}`">
                                                                <q-item-section>
                                                        ...
                                                        <template v-if="auth.canView('catinvent/delete')">
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'catinventlist',
		},
		apiPath : {
			type : String,
			default : 'catinvent/index',
		},
		autoLoad: {
			type: Boolean,
			default: true,
