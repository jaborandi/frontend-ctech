                    ...
                    <div class="row justify-between items-center q-col-gutter-md">
                        <div  class="col col-md-auto " >
                            <div class=" text-h6 text-primary" >
                                Agenda do Laboratorio de Informática
                            </div>
                        </div>
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/agendalaboratorio/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   @click="app.openPageDialog({ page: 'agendalaboratorio/add', url: `/agendalaboratorio/add` , closeBtn: true  })"  class="full-width" >
            ...
            <div class="container-fluid">
                <div class="row q-col-gutter-x-md">
                    <div  class="col comp-grid"  v-if="1<0">
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && pageBreadCrumb.fieldName">
                                <q-card class="q-pa-md q-mb-sm text-bold nice-shadow-16">
                                    <q-breadcrumbs>
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="pageBreadCrumb.fieldName" to="/agendalaboratorio"></q-breadcrumbs-el>
                        ...
                        <div >
                            ...
                            :bordered="false"
                            :columns="app.menus.agendalaboratoriolistheader" 
                            :rows="records"
                            ...
                            <template v-slot:body="props">
                                <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                    ...
                                    <q-td  key="id" :props="props">
                                        <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/agendalaboratorio/view/${props.row.id}`">{{ props.row.id }}</q-btn>
                                    </q-td>
                                    <q-td  key="titulo" :props="props">
                                        {{ props.row.titulo }}
                                    </q-td>
                                    <q-td  key="numero_pessoas" :props="props">
                                        {{ props.row.numero_pessoas }}
                                    </q-td>
                                            ...
                                            <q-btn icon="menu" padding="xs" round flat color="grey">
                                                <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                    <q-list dense rounded nav>
                                                        <template v-if="auth.canView('agendalaboratorio/view')">
                                                            <q-item link clickable v-ripple :to="`/agendalaboratorio/view/${props.row.id}`">
                                                                <q-item-section>
                                                        ...
                                                        <template v-if="auth.canView('agendalaboratorio/edit')">
                                                            <q-item link clickable v-ripple :to="`/agendalaboratorio/edit/${props.row.id}`">
                                                                <q-item-section>
                ...
                <div  class="col-12 comp-grid" >
                    <q-card  :flat="isSubPage" class="q-mb-sm q-pa-md nice-shadow-16">
                        <div class="" >
                            <AgendalaboratorioListCalendar :records="records" />
                            </div>
                        </q-card>
                    </div>
                </div>
...
<script setup>
	...
	import AgendalaboratorioListCalendar from 'src/pages/agendalaboratorio/agendalaboratoriolistcalendar.vue';
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'agendalaboratoriolist',
		},
		apiPath : {
			type : String,
			default : 'agendalaboratorio/index',
		},
		autoLoad: {
			type: Boolean,
			default: true,
