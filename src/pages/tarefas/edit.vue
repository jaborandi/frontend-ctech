                                    ...
                                    <div class="row q-col-gutter-x-md">
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input  ref="ctrlfazer_ate" v-model="formData.fazer_ate" label="Fazer Ate"    :error="isFieldValid('fazer_ate')" :error-message="getFieldError('fazer_ate')">
                                                    <template v-slot:append>
                                                        <q-icon name="date_range" class="cursor-pointer">
                                                        <q-popup-proxy ref="ctrlfazer_ate" transition-show="scale" transition-hide="scale">
                                                        <q-date    mask="YYYY-MM-DD" v-model="formData.fazer_ate" @input="$refs.ctrlfazer_ate.hide()" />
                                                        </q-popup-proxy>
                                                        </q-icon>
                                                    </template>
                                                    </q-input>      
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlprioridade" v-model.trim="formData.prioridade"  label="Prioridade" type="text" placeholder="Entrar Prioridade"      
                                                    class="" :error="isFieldValid('prioridade')" :error-message="getFieldError('prioridade')">
                                                    </q-input>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlusuarios" v-model.trim="formData.usuarios"  label="Usuarios" type="text" placeholder="Entrar Usuarios"      
                                                    class="" :error="isFieldValid('usuarios')" :error-message="getFieldError('usuarios')">
                                                    </q-input>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input  ref="ctrlfeedback" rows="5"  v-model="formData.feedback" placeholder="Entrar Feedback"    type="textarea" :error="isFieldValid('feedback')" :error-message="getFieldError('feedback')">
                                                    </q-input>
                                                </div>
                                            </div>
                                        </div>
