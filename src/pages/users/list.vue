                        ...
                        <div >
                            ...
                            <template v-slot:body="props">
                                <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                    ...
                                    <q-td  key="cor_postit" :props="props">
                                        {{ props.row.cor_postit }}
                                    </q-td>
                                    <q-td  key="cor_letra" :props="props">
                                        {{ props.row.cor_letra }}
                                    </q-td>
                                    ...
                                    <q-td  key="cargo_usuario" :props="props">
                                        <q-btn v-if="props.row.cargo_usuario" @click="app.openPageDialog({ page: 'cargos/view', url: `/cargos/view/${props.row.cargo_usuario}` , closeBtn: true })" padding="xs" flat color="primary" no-caps >
