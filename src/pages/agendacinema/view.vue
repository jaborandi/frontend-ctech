                        ...
                        <div  class="col comp-grid" >
                            <div >
                                ...
                                <div class="row q-col-gutter-xs justify-start q-ma-md">
                                    <template v-if="auth.canView('agendacinema/edit')">
                                        <div><q-btn icon="edit" label="Edit"  outline  :rounded="false"  no-caps  unelevated   padding="xs" color="positive" title="Editar"  :to="`/agendacinema/edit/${item.id}`">
                                        </q-btn></div>
                                    </template>
                                    <template v-if="auth.canView('agendacinema/delete')">
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'agendacinemaview',
		},
		apiPath: {
			type: String,
			default: 'agendacinema/view',
		},
		autoLoad: {
			type: Boolean,
			default: true,
